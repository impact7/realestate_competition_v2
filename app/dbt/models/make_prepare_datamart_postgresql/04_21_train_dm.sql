...
select
    ...
    t17.med_target_price_500m,
    t17.avg_target_price_500m,
    t17.med_target_price_1km,
    t17.avg_target_price_1km,
    t17.med_target_price_3km,
    t17.avg_target_price_3km,
    t17.med_target_price_city,
    t17.avg_target_price_city,
...
from
    ...
    on
        t1.id = t19.id
    left join
    {{ ref('03_11_dm_prefecture') }} as t20
    on
        t1.id = t20.id
order by
    t1.id
